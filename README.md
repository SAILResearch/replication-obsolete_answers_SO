...
under revision for [IEEE Transactions on Software Engineering](https://doi.org/10.5281/zenodo.1320311){:target="_blank"}
...
- Quantitative Data:
  - [all 58201 observations of obsolete answers (QuestionID, AnswerID, CommentID, CommentText)](https://github.com/SAILResearch/replication-classifier_conf_config_bugloc/files/1738073/bugs-to-files.zip){:target="_blank"}
- Qualitative Data:
  - [all 700 obsolete answers in RQs (with labels)](https://github.com/SAILResearch/replication-classifier_conf_config_bugloc/files/1490023/all-classifier-results.zip){:target="_blank"}
